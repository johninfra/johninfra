...
- **[Entra ID Administration with PowerShell & Microsoft Graph](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-26-Microsoft-EntraID-Administration-with-PowerShell-and-Microsoft-Graph)** — Used Microsoft Graph PowerShell with delegated OAuth scopes to enumerate users and groups, inspect privileged role assignments, validate RBAC context, and securely close the administrative session.
- **[Splunk SIEM Security Monitoring & Alerting Platform](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-18-Splunk-SIEM-Security-Monitoring-and-Alerting-Platform)** — Deployed Splunk, ingested security telemetry, built SPL searches and dashboards, and configured real-time alerts to detect simulated reconnaissance activity.
- **[Splunk SOC Security Monitoring Dashboard](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-19-Splunk-SOC-Security-Monitoring-Dashboard)** — Analyzed Windows Security and Sysmon telemetry for authentication activity, process execution, and threat-detection use cases in a SOC-style monitoring workflow.
- **[PowerShell Vulnerability Management & Security Audit Framework](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-22-PowerShell-Vulnerability-Management-and-Security-Audit-Framework)** — Automated Windows endpoint inventory, security-control assessment, service analysis, vulnerability-oriented checks, and structured risk reporting with PowerShell.
- **[PowerShell Endpoint Security Dashboard](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-24-PowerShell-Security-Awareness-Dashboard)** — Built a Windows security posture dashboard covering Defender, Event Logs, WMI/CIM, endpoint controls, and automated HTML reporting.
- **[Linux Web Infrastructure & TLS](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-25-Linux-Web-Infrastructure-and-Security-Configuration)** — Administered Ubuntu over SSH, deployed Nginx, and configured and validated HTTPS/TLS using a self-signed certificate.
- **[Active Directory Group-Based Access Control](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-04-Active-Directory-Access-Control)** — Implemented AD security-group-based access with NTFS and share permissions to demonstrate least privilege and enterprise access-control concepts.
- **[Windows Server 2022 RDP Configuration & Troubleshooting](https://github.com/johninfra/it-support-and-cybersecurity-labs/tree/main/Lab-20-Configuring-and-Troubleshooting-Remote-Desktop-Protocol-on-Windows-Server-2022)** — Configured and troubleshot Remote Desktop on Windows Server 2022, including firewall rules, TCP/UDP 3389, connectivity validation, and remote-access troubleshooting.
